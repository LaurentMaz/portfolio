...
const Work = ({ isDarkMode, setIsDarkMode }: ThemeProps) => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <h2 className="text-center text-5xl font-ovo mb-10">Mes réalisations</h2>
      ...
      <div className="grid grid-cols-[grid-template-columns:repeat(auto-fit,minmax(200px,1fr))] my-10 gap-5">
